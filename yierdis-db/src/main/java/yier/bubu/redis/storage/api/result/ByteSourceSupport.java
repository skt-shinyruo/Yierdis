...
abstract class ByteSourceSupport implements AutoCloseable {
    ...
    private static final class CountingLengthSink implements IntConsumer {
        private final IntConsumer delegate;
        private final int expected;
        private int count;

        private CountingLengthSink(IntConsumer delegate, int expected) {
