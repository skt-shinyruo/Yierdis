...
final class YierdisDbKeyLifecycle implements AutoCloseable {
    ...
    interface EntryScanConsumer {
        boolean accept(AllocatorKeyHandle keyHandle, EntryRecord record);
    }
    ...
    AllocatorKeyHandle keyHandle(byte[] keyBytes) {
        if (keyBytes == null) {
            return null;
        }
    ...
    AllocatorKeyHandle keyHandle(BytesView keyView) {
        if (keyView == null) {
            return null;
        }
    ...
    EntryRecord entryRecord(AllocatorKeyHandle keyHandle) {
        if (keyHandle == null) {
            return null;
        }
    ...
    CurrentEntry currentEntry(byte[] keyBytes) {
        ...
        AllocatorKeyHandle keyHandle = handle == null ? null : ownedResources.keyDirectory.getKeyHandle(keyBytes);
    ...
    EntryRecord liveEntryRecord(byte[] keyBytes) {
        ...
        AllocatorKeyHandle keyHandle = keyHandle(keyBytes);
    ...
    private EntryRecord liveEntryRecord(AllocatorKeyHandle keyHandle, EntryRecord record) {
    ...
    void forEachKeyHandle(BiConsumer<AllocatorKeyHandle, EntryRecord> consumer) {
    ...
    Long expireAtMillis(AllocatorKeyHandle keyHandle) {
        return expireAtMillis(entryRecord(keyHandle));
    }

    long estimatedBytesForRemoval(AllocatorKeyHandle keyHandle, EntryRecord record) {
        if (keyHandle == null || record == null) {
            return 0L;
        }
    ...
    boolean isCurrentExpiredCandidate(
        ...
        NativeHandle expectedIdentity = expectedKeyHandle == null
                ? null
                : expectedKeyHandle.nativeHandle();
    ...
    boolean isKeyExpiredForScan(AllocatorKeyHandle keyHandle, long nowMillis) {
        if (keyHandle == null) {
            return false;
        }
    ...
    EntryRecord touchRecord(AllocatorKeyHandle keyHandle, EntryRecord record) {
        if (keyHandle == null || record == null) {
            return record;
        }
    ...
    EntryRecord withExpireAtMillis(AllocatorKeyHandle keyHandle, EntryRecord record, long expireAtMillis) {
        if (keyHandle == null || record == null) {
            return record;
        }
        return new EntryRecord(
    ...
    private static NativeHandle keyHandleIdentity(AllocatorKeyHandle keyHandle) {
        if (keyHandle == null) {
            return NativeHandle.NULL;
        }
        return keyHandle.nativeHandle();
    }

    private EntryRecord currentRecordForIdentity(byte[] keyBytes, AllocatorKeyHandle expectedKeyHandle) {
        if (keyBytes == null || expectedKeyHandle == null) {
            return null;
        }
        NativeHandle expectedIdentity = expectedKeyHandle.nativeHandle();
        if (expectedIdentity == null) {
            return null;
        }
        AllocatorKeyHandle currentKeyHandle = ownedResources.keyDirectory.getKeyHandle(keyBytes);
        if (currentKeyHandle == null
                || !expectedIdentity.equals(currentKeyHandle.nativeHandle())) {
            return null;
        }
    ...
    private static byte[] keyBytes(AllocatorKeyHandle keyHandle) {
