...
final class YierdisHashOps implements HashOps {
    ...
    private EntryRecord liveHashRecord(YierdisDbKernel kernel, byte[] keyBytes) {
        AllocatorKeyHandle keyHandle = keyLifecycle.keyHandle(keyBytes);
    ...
    private EntryRecord hashRecord(AllocatorKeyHandle keyHandle, ValueHandle handle, long expireAtMillis, EntryRecord previous) {
