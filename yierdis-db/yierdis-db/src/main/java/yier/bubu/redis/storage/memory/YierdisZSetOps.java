...
final class YierdisZSetOps implements ZSetOps {
    ...
    private EntryRecord liveZSetRecord(YierdisDbKernel kernel, byte[] keyBytes) {
        AllocatorKeyHandle keyHandle = keyLifecycle.keyHandle(keyBytes);
    ...
    private EntryRecord zsetRecord(AllocatorKeyHandle keyHandle, ValueHandle handle, long expireAtMillis, EntryRecord previous) {
        return zsetRecord(
                keyHandle,
                handle,
                expireAtMillis,
