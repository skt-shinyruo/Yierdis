...
final class YierdisSetOps implements SetOps {
            ...
            public PreparedDbMutation<WriteResult<Long>> prepare() {
                ...
                if (current != null) {
                    ...
                    if (expectedAdditions == 0) {
                        return kernel.unchanged(WriteResult.of(0L, MutationOutcome.NONE));
                    }
                }
                ...
                try {
                    ...
                    PreparedDbMutation<WriteResult<Long>> prepared = kernel.upsert(
                            result,
                            deltaBytes,
    ...
    private EntryRecord liveSetRecord(YierdisDbKernel kernel, byte[] keyBytes) {
        AllocatorKeyHandle keyHandle = keyLifecycle.keyHandle(keyBytes);
    ...
    private EntryRecord setRecord(AllocatorKeyHandle keyHandle, ValueHandle handle, long expireAtMillis, EntryRecord previous) {
