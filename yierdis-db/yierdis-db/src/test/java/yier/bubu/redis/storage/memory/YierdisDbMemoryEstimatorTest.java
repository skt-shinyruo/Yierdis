...
public class YierdisDbMemoryEstimatorTest {
    @Test
    public void estimatesRawStringEntryMetadata() {
        Assert.assertEquals(
                DbMemoryConstants.ENTRY_OVERHEAD_BYTES_ESTIMATE,
                YierdisDbMemoryEstimator.entryMetadataBytes(record(ValueEncoding.STRING_RAW, 1L))
        );
    }
    ...
    public void estimatesIntegerEncodedStringPayloadAsLongBytes() {
        Assert.assertEquals(
                DbMemoryConstants.ENTRY_OVERHEAD_BYTES_ESTIMATE + Long.BYTES,
                YierdisDbMemoryEstimator.entryMetadataBytes(record(ValueEncoding.STRING_INT, 1L))
        );
    }
