...
public class MutationFaultInjectionTest {
    ...
    public void stringMutationFamilyIsFailureAtomic() {
        assertFailureAtomic(
                ...
                new MutationCase(
                        ...
                        fixture -> fixture.stringOps.setString(PRIMARY_KEY, b("old"), SetMode.NORMAL, null),
                        fixture -> {
                            WriteResult<StringOps.SetStringValue> result = TestDbSupport.commitSetWithOldValue(
                                    fixture.stringOps,
                                    PRIMARY_KEY,
                                    slice("new"),
                                    SetMode.NORMAL,
    ...
    private static final class FaultFixture implements AutoCloseable {
        ...
        private byte[] primaryStringValue() {
            ...
            return OwnedReplyValueAssertions.stringValue(stringOps, PRIMARY_KEY);
        }
        ...
        private String entrySnapshot(AllocatorKeyHandle keyHandle, EntryHandle entryHandle, EntryRecord record) {
        ...
        private static String nativeHandleIdentity(AllocatorKeyHandle keyHandle) {
            return nativeHandleIdentity(keyHandle == null ? null : keyHandle.nativeHandle());
        }
