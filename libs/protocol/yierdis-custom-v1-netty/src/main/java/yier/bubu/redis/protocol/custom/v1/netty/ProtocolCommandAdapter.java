...
// 协议请求到执行命令的适配器：保持 Custom Protocol v1 的 UTF-8/null argv 语义，同时把协议层与 execution-api 解耦。

import io.netty.channel.ChannelHandlerContext;
import io.netty.channel.ChannelInboundHandlerAdapter;
import yier.bubu.redis.protocol.custom.v1.wire.CustomProtocolV1ArgvRequest;
import yier.bubu.redis.protocol.custom.v1.execution.CustomProtocolV1ExecutionAdapter;
