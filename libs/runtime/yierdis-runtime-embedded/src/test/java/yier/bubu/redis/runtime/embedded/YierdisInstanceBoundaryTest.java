...
public class YierdisInstanceBoundaryTest {
    ...
    public void instanceShouldExposeObservabilitySeam() throws Exception {
        ...
        try {
            observabilityType = Class.forName("yier.bubu.redis.runtime.embedded.YierdisInstanceObservability");
    ...
    public void observabilityShouldExposeDbSummariesApi() throws Exception {
        Class<?> observabilityType = Class.forName("yier.bubu.redis.runtime.embedded.YierdisInstanceObservability");
