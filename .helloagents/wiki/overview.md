...
| protocol | 协议层（`protocol-model` 端口/模型 + `protocol-codec` JSON/v1 codec；`yierdis-protocol` 为父 POM/聚合层） | ✅Stable | [modules/protocol.md](modules/protocol.md) |
...
| client | 内置 Custom Protocol v1 CLI 客户端（用于调试） | ✅Stable | [modules/client.md](modules/client.md) |
