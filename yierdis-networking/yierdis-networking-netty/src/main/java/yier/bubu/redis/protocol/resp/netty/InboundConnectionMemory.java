...
public final class InboundConnectionMemory implements AutoCloseable {
    ...
    public InboundConnectionMemory(String id, long hardLimitBytes, Executor resumeExecutor, Runnable resumeCallback) {
        this.account = new ConnectionMemoryAccount(id, hardLimitBytes);
    ...
    public ConnectionMemoryAccount account() {
        return account;
    }
