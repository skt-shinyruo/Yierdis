...
public class YierdisServerBootstrapCloseTest {
    ...
    private static YierdisServerBootstrap newBootstrap(YierdisServerRuntimeConfig config) throws Exception {
        Constructor<YierdisServerBootstrap> ctor = YierdisServerBootstrap.class.getDeclaredConstructor(YierdisServerRuntimeConfig.class);
