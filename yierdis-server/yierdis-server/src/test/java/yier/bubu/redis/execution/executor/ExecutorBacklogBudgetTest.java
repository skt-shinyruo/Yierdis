...
public class ExecutorBacklogBudgetTest {
    ...
    public void capacityWaiterWakesOnceAfterReservationIsReleased() {
        ...
        Runnable registration = budget.onCapacityAvailable(
                8,
    ...
    public void waiterRegisteredAfterCapacityReturnsWakesImmediatelyOnce() {
        ...
        Runnable registration = budget.onCapacityAvailable(8, wakeups::incrementAndGet);
    ...
    public void claimedWaiterCannotBeCancelledWhileEarlierCallbackRuns() throws Exception {
        ...
        Runnable second = budget.onCapacityAvailable(0, secondWakeups::incrementAndGet);
        ...
        Thread canceller = Thread.ofPlatform().start(second);
    ...
    public void shutdownWakesEveryWaiterOnce() {
        ...
        Runnable late = budget.onCapacityAvailable(0, registeredAfterShutdown::incrementAndGet);
