...
public class BenchmarkConfigTest {
    ...
    public void normalizesHostAndTestSelection() {
        BenchmarkConfig config = new BenchmarkConfig(
                ...
                Set.of(" SET ", "get", "GET", "  "), 3, 7L, BenchmarkFormat.HUMAN, 0
        );
    ...
    @Test
    public void nullTestSelectionBecomesEmpty() {
        BenchmarkConfig config = new BenchmarkConfig(
                "127.0.0.1", 16378, 100, 4, 3, 1, OptionalLong.empty(), true,
                null, 3, 7L, BenchmarkFormat.HUMAN, 0
        );
    ...
    private static BenchmarkConfig config(
        ...
        return new BenchmarkConfig(
                ...
                Set.of(), precision, 7L, BenchmarkFormat.HUMAN, database
        );
    }
