...
public class StorageBenchmarkRunnerTest {
    ...
    public void smallRealDatabaseRunReportsConsistentStructureAndAccounting() {
        ...
        Assert.assertTrue(result.latency().p99() >= result.latency().p50());
        ...
        Assert.assertTrue(result.ttlChurn().latency().p99() >= result.ttlChurn().latency().p50());
        ...
        Assert.assertTrue(result.deletion().latency().p99() >= result.deletion().latency().p50());
