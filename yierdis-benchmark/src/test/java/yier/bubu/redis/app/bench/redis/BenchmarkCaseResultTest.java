...
public class BenchmarkCaseResultTest {
    private final RedisBenchmarkCase testCase = CaseSelection.caseById("set");
    ...
    public void runResultPreservesOrderAndDefensivelyCopiesRows() {
        ...
        BenchmarkCaseResult get = BenchmarkCaseResult.unsupported(CaseSelection.caseById("get"), "missing");
    ...
    @Test
    public void runResultRejectsNullRows() {
    ...
    public void emptyAndNonFailedRunsExitZeroWhileAnyFailureExitsOne() {
        ...
        BenchmarkCaseResult unsupported = BenchmarkCaseResult.unsupported(
                CaseSelection.caseById("spop"), "missing"
        );
        BenchmarkCaseResult skipped = BenchmarkCaseResult.skipped(
                CaseSelection.caseById("lrange_100"), "dependency"
        );
        BenchmarkCaseResult failed = BenchmarkCaseResult.failed(CaseSelection.caseById("get"), 7, "disconnect");
